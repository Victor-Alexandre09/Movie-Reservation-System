...
class ShowTimeServiceTest {
        ...
        // @InjectMocks - Removed because of primitive type injection issue
        ...
        @BeforeEach
        void setUp() {
                // Manually instantiate service to handle @Value injection
                showTimeService = new ShowTimeService(showTimeRepository, movieService, theaterService, TIME_INTERVAL);
        ...
        void createShowTime_Success() {
                // Given
                ShowTimeDTO.Request requestDto = new ShowTimeDTO.Request(
        ...
        void createShowTime_Failure_TheaterNotAvailable() {
                ...
                // When & Then
                TheaterNotAvailableException exception = assertThrows(
                                TheaterNotAvailableException.class,
        ...
        void getShowTime_Failure_NotFound() {
                ...
                assertEquals("ShowTime not found for id: 99", exception.getMessage());
        }
        ...
        /**
         * Tests the case where show times are requested for a movie ID that does not
         * exist.
         * Verifies that an EntityNotFoundException is thrown and the repository is
         * never queried.
         */
        @Test
        ...
        void getShowTimesByMovieId_MovieNotFound() {
                ...
                // Verify that the repository was NOT called, because the movie check failed
                // first
        ...
        void getShowTimesByDate_Success_UTC() {
                ...
                // Verify the repository was called with the correctly calculated date
                // boundaries
        ...
        void updateShowTime_Success_AllFields() {
                ...
                ShowTimeDTO.UpdateRequest updateRequestDto = new ShowTimeDTO.UpdateRequest(
                ...
                given(showTimeRepository.findConflictingShows(eq(2L), eq(newStartTime), eq(expectedNewEndTime),
                                eq(showTimeId)))
                                .willReturn(List.of());

                given(showTimeRepository.save(any(ShowTime.class))).willReturn(testShowTime); // Return the mutated
                                                                                              // object
        ...
        void updateShowTime_Success_PartialUpdate_PriceOnly() {
                ...
                // End time should be recalculated based on existing start time and movie
                // duration
